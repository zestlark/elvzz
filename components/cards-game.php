<?php
require('test.php');
$games1 = scrap($main . '/games');
$games2 = scrap($main . '/games/premium');
...
<div class="_wrap flex container justify-center mx-auto">
    ...
    <section class="text-gray-600 body-font px-4">
        <div class="container px-5 py-24 mx-auto">
            <h1 class="text-1xl p-3 mb-8 -mt-5 rounded font-medium sticky bg-gray-100" style="z-index: 3;top:75px">Games
            </h1>
